...
/**
 * @ORM\Table(name="tte_usuarios_configuracion")
 * @ORM\Entity(repositoryClass="Brasa\TransporteBundle\Repository\TteUsuariosConfiguracionRepository")
 */
class TteUsuariosConfiguracion
{
    /**
     * @ORM\Id
    ...
    protected $usuarioRel;
     ...
     /**
     * @ORM\ManyToOne(targetEntity="TtePuntosOperacion", inversedBy="usuariosConfiguracionRel")
     ...
     * @return TteUsuariosConfiguracion
     */
