...
/**
 * @ORM\Table(name="tte_recibos_caja")
 * @ORM\Entity(repositoryClass="Brasa\TransporteBundle\Repository\TteRecibosCajaRepository")
 */
class TteRecibosCaja
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\ManyToOne(targetEntity="TteGuias", inversedBy="recibosCajaRel")
