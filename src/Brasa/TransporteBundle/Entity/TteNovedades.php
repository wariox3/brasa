...
/**
 * @ORM\Table(name="tte_novedades")
 * @ORM\Entity(repositoryClass="Brasa\TransporteBundle\Repository\TteNovedadesRepository")
 */
class TteNovedades
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="TteNovedadesConceptos", inversedBy="novedadesRel")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="TteGuias", inversedBy="novedadesRel")
     ...
     *
     * @param \Brasa\TransporteBundle\Entity\TteNovedadesConceptos $novedadConceptoRel
     * @return TteNovedades
     */
    public function setNovedadConceptoRel(\Brasa\TransporteBundle\Entity\TteNovedadesConceptos $novedadConceptoRel = null)
    {
     ...
     *
     * @return \Brasa\TransporteBundle\Entity\TteNovedadesConceptos 
     */
