 ...
 */
class AfiConsecutivoRepository extends EntityRepository {
    /**
    ...
    public function consecutivo($codigoConsecutivo) {
        ...
        $intNumero = 0;
        $arConsecutivo = new \Brasa\AfiliacionBundle\Entity\AfiConsecutivo();
        $arConsecutivo = $em->getRepository('BrasaAfiliacionBundle:AfiConsecutivo')->find($codigoConsecutivo);     
