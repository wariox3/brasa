...
class Empleado extends \FPDF_FPDF {
    ...
    public function Header() {
        ...
        $arContrato = self::$em->getRepository('BrasaAfiliacionBundle:AfiContrato')->find($arEmpleado->getCodigoContratoActivo());        
