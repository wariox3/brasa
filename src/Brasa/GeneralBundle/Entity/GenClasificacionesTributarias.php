 ...
 * @ORM\Entity(repositoryClass="Brasa\GeneralBundle\Repository\GenClasificacionesTributariasRepository")
 */
class GenClasificacionesTributarias
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="GenTerceros", mappedBy="clasificacionTributariaRel")
     */
     ...
     * @return GenClasificacionesTributarias
     */
     ...
     *
     * @param \Brasa\GeneralBundle\Entity\GenTerceros $tercerosClasificacionTributariaRel
     * @return GenClasificacionesTributarias
     */
    public function addTercerosClasificacionTributariaRel(\Brasa\GeneralBundle\Entity\GenTerceros $tercerosClasificacionTributariaRel)
    {
     ...
     * @param \Brasa\GeneralBundle\Entity\GenTerceros $tercerosClasificacionTributariaRel
     */
    public function removeTercerosClasificacionTributariaRel(\Brasa\GeneralBundle\Entity\GenTerceros $tercerosClasificacionTributariaRel)
    {
