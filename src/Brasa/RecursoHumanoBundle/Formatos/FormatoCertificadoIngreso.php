...
class FormatoCertificadoIngreso extends \FPDF_FPDF {
    ...
    public static $floIbc;
    //public static $auxilioTransporte;
    //public static $periodoCertificadoDesde;
    //public static $periodoCertificadoHasta;
    
    public function Generar($miThis, $codigoEmpleado,$strFechaExpedicion,$strLugarExpedicion,$strFechaCertificado,$strAfc,$strCertifico1,$strCertifico2,$strCertifico3,$strCertifico4,$strCertifico5,$strCertifico6,$floIbc) {
        ob_clean();
    ...
    public function EncabezadoDetalles() {
        ...
        $this->Cell(30, 6, self::$floIbc , 1, 0, 'C', 1);
        ...
        $this->SetXY(5, 78);
        $this->SetFont('Arial','',8);
        $this->Cell(65, 6, utf8_decode("30. DE:   31. A: ") , 1, 0, 'C', 1);
        ...
        $this->Cell(34, 6, round(self::$floIbc) , 1, 0, 'R', 1);
        $this->SetXY(5, 102);
