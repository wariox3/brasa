...
class FormatoCentroCostos extends \FPDF_FPDF {
    ...
    public function EncabezadoDetalles() {
        ...
        $w = array(10, 72, 72, 20, 20, 30, 20, 20, 20);
    ...
    public function Body($pdf) {
        ...
        foreach ($arCentroCostos as $arCentroCostos) {            
            $pdf->Cell(10, 4, $arCentroCostos->getCodigoCentroCostoPk(), 1, 0, 'L');
            $pdf->Cell(72, 4, $arCentroCostos->getNombre(), 1, 0, 'L');
            $pdf->Cell(72, 4, $arCentroCostos->getTerceroRel()->getNombreCorto(), 1, 0, 'L');
            $pdf->Cell(20, 4, $arCentroCostos->getPeriodoPagoRel()->getNombre(), 1, 0, 'L');
            $pdf->Cell(20, 4, $arCentroCostos->getFechaUltimoPagoProgramado()->format('Y/m/d'), 1, 0, 'L');
