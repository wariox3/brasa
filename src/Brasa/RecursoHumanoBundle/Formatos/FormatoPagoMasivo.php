...
class FormatoPagoMasivo extends \FPDF_FPDF {
    ...
    public function Header() {
        ...
        //INFORMACIÓN EMPRESA
        $this->Cell(150, 7, "", 0, 0, 'C', 1);//$this->Cell(150, 7, utf8_decode("COMPROBANTE PAGO ". $arPago->getPagoTipoRel()->getNombre().""), 0, 0, 'C', 1);
        $this->SetXY(53, 22);
    ...
    public function Body($pdf) {
        ...
        foreach ($arPagos as $arPago){
            ...
            $arPagoDetalle = self::$em->getRepository('BrasaRecursoHumanoBundle:RhuPagoDetalle')->findBy(array('codigoPagoFk' => $arPago->getCodigoPagoPk()));
            ...
            // INFORMACION DE CREDITOS
                ...
                $arPagoDetalles = self::$em->getRepository('BrasaRecursoHumanoBundle:RhuPagoDetalle')->findBy(array('codigoPagoFk' => $arPago->getCodigoPagoPk()));
