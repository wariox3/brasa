...
/**
 * @ORM\Table(name="rhu_curso_supervigilancia")
 * @ORM\Entity(repositoryClass="Brasa\RecursoHumanoBundle\Repository\RhuCursoSupervigilanciaRepository")
 */
class RhuCursoSupervigilancia
{
    /**
     * @ORM\Id
     * @ORM\Column(name="codigo_curso_supervigilancia_pk", type="integer")
     * @ORM\GeneratedValue(strategy="AUTO")
     */
    private $codigoCursoSuperVigilanciaPk;
    ...
    /**
     * @ORM\Column(name="vigencia", type="string", length=60)
     */    
    private $vigencia;
