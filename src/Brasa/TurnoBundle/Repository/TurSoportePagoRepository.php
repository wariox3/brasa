...
class TurSoportePagoRepository extends EntityRepository {
    ...
    private function insertarSoportePago ($arSoportePago, $arSoportePagoPeriodo, $arProgramacionDetalle, $dateFechaDesde, $dateFechaHasta, $codigoTurno, $dateFecha, $dateFecha2, $boolFestivo, $boolFestivo2) {        
        $em = $this->getEntityManager();      
