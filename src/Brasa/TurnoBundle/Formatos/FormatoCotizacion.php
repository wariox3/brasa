...
class FormatoCotizacion extends \FPDF_FPDF {
    ...
    public function Header() {
        ...
        $this->Cell(30, 6, $arCotizacion->getCodigoCotizacionPk(), 1, 0, 'L', 1);
        $this->SetFont('Arial','B',8);
        $this->Cell(30, 6, "NOMBRE:" , 1, 0, 'L', 1);
        $this->SetFont('Arial','',7);
        $this->Cell(100, 6, utf8_decode($arCotizacion->getCodigoCotizacionPk()), 1, 0, 'L', 1);
        $this->SetXY(10, $intY + 5);
        $this->SetFont('Arial','B',8);
        $this->Cell(30, 6, "FECHA:" , 1, 0, 'L', 1);
        $this->SetFont('Arial','',8);
        $this->Cell(30, 6, $arCotizacion->getFecha()->format('Y/m/d') , 1, 0, 'L', 1);
        ...
        $this->SetFont('Arial','',8);
        $this->Cell(160, 5, $arCotizacion->getComentarios() , 1, 0, 'L', 1);        
    ...
    public function EncabezadoDetalles() {
        $this->Ln(14);
        $header = array('COD', 'TURNO', 'MODALIDAD');
        $this->SetFillColor(236, 236, 236);
        $this->SetTextColor(0);
    ...
    public function Body($pdf) {
        ...
        foreach ($arCotizacionDetalles as $arCotizacionDetalle) {            
            ...
            $pdf->Cell(10, 4, $arCotizacionDetalle->getTurnoRel()->getNombre(), 1, 0, 'L');
            $pdf->Cell(10, 4, $arCotizacionDetalle->getModalidadServicioRel()->getNombre(), 1, 0, 'L');                
            $pdf->Ln();
