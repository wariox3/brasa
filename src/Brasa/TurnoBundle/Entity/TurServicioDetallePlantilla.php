...
/**
 * @ORM\Table(name="tur_servicio_detalle_plantilla")
 * @ORM\Entity(repositoryClass="Brasa\TurnoBundle\Repository\TurServicioDetallePlantillaRepository")
 */
class TurServicioDetallePlantilla
{
    /**
     * @ORM\Id
     * @ORM\Column(name="codigo_servicio_detalle_plantilla_pk", type="integer")
     * @ORM\GeneratedValue(strategy="AUTO")
     */
    private $codigoServicioDetallePlantillaPk;      
    ...
    /**
     * @ORM\ManyToOne(targetEntity="TurServicioDetalle", inversedBy="serviciosDetallesPlantillasServicioDetalleRel")
    ...
    /**
     * Get codigoServicioDetallePlantillaPk
     *
     * @return integer
     */
    public function getCodigoServicioDetallePlantillaPk()
    {
        return $this->codigoServicioDetallePlantillaPk;
    }
