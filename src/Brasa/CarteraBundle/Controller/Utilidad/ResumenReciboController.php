<?php
namespace Brasa\CarteraBundle\Controller\Utilidad;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Route;
use Doctrine\ORM\EntityRepository;
use Symfony\Component\HttpFoundation\Request;
class ResumenReciboController extends Controller
{
    var $strListaDql = "";
    
    /**
     * @Route("/cartera/utilidad/resumen/recibo/", name="brs_cartera_utilidad_resumen_recibo")
     */    
